...
const { details, validId, validBoolean } = require("../validation/validators");
...
const updateBlog = async function (req, res) {
    try {
            ...
            let { title, body, tags, subcategory, isPublished, publishedAt } = categorys;
       ...
       const blog = await blogModel.findByIdAndUpdate ({ _id:Id, isDeleted: false },
        {
            $set: { isPublished: isPublished, body:body, title: title , publishedAt: new Date() },
